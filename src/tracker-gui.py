...
signal.signal(signal.SIGINT, handle_exit_signal)  # for Ctrl+C too


def save_results_and_exit():
    print("\nSaving results to 'score_log.csv'...", flush=True)
...
try:
    ...
    while not os.path.exists(STOP_FILE):
        ...
        print(f"[{timestamp}] Team 1: {score1_val}, Team 2: {score2_val}, Time: {timer_text}", flush=True)
